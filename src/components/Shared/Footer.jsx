...
const Footer = () => {
    return (
        ...
        <div className="lg:w-1/3" >
          <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
            <div className="flex items-center justify-center w-16 h-16 rounded-full " >
             <img src="https://i.ibb.co.com/1qxVD9d/favicon-32x32.png" alt="" />
            </div>
            <span className="self-center text-xl italic uppercase font-bold">ProductHub</span>
          </a>
        </div>
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4" >
          <div className="space-y-3" >
            <h3 className="tracking-wide uppercase text-gray-50 dark:text-gray-900 font-semibold">Product</h3>
          ...
          <div className="space-y-3" >
            <h3 className="tracking-wide uppercase text-gray-50 dark:text-gray-900 font-semibold">Company</h3>
            <ul className="space-y-1 font-medium">
              <li>
          ...
          <div className="space-y-3" >
            <h3 className="uppercase text-gray-50 dark:text-gray-900 font-semibold">Developers</h3>
            <ul className="space-y-1 font-medium">
              <li>
      ...
      <div className="py-6 text-sm text-center  font-semibold" >© 2024 Product Hub | | All rights reserved.</div>
    </footer>
    );
};
